            ...
            <tbody class="table-group-divider">
                <?php foreach ($profesores as $key => $value):?>
                    <tr class="table-secondary">
                        <td><?php echo $value->id_profesor?></td>
                        <td><?php echo $value->nombre_profesor?></td>
                        <td><?php echo $value->apellido_profesor?></td>
                        <td><?php echo $value->edad_profesor?></td>
                        <td><?php echo $value->descripcion_sexo?></td>  
                        <td><a href="<?php echo base_url('welcome/form_edit_profesor/'.$value->id_profesor);?>"><ion-icon name="create-outline"></ion-icon></a></td>     
                        <td><a href="<?php echo base_url('welcome/delete_profesor/'.$value->id_profesor);?>"><ion-icon name="trash-bin-outline"></ion-icon></a></td>                         
                    </tr>
                <?php endforeach;?>    
            </tbody>
        </table>
